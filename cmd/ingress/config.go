...
var controllerWebhookPort = flag.Int("ctrl-webhook-ort", 8080, "TCP-Port under which the kubebuilder controller webhook server runs, currently unused.")
...
var healthPath = flag.String("health-path", "/health", "Path under which the health endpoint runs.")
...
var readinessPath = flag.String("ready-path", "/ready", "Path under which the ready endpoint runs (health port).")
